...
function invertKeyValues(obj, fn = null) {
...
const inverted = invertKeyValues(data);
console.log(inverted); // Output: { 1: ['a', 'c'], 2: ['b'] }

const invertedWithFn = invertKeyValues(data, value => value * 2);
console.log(invertedWithFn); // Output: { 2: ['a', 'c'], 4: ['b'] }
